...
import { getBookingsByRestaurantId, createBooking } from "../services/bookingService";
...
export function BookingPage() {
    ...
    function handleSearchAvailableTimes(e: FormEvent) {
        ...
        const matchingBookings = allBookings.filter((booking) => inputDate === booking.date);
        ...
        if (matchingBookings.length >= 30) {
            ...
            const availableTimes = ["18:00", "21:00"].filter((time) => !bookedTimes.includes(time));
